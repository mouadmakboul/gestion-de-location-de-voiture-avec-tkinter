...
def getting_values():
    ...
    server = smtplib.SMTP('smtp.gmail.com',587)#Here type your port no.. 
...
l1_name = Label(Home, text = 'Entrer votre Email')
...
l2_name = Label(Home, text = 'Entrez ladresse  du destinataire')
...
l4_name = Label(Home, text = 'Entrez votre message')
